...
import static danekerscode.socialmediaapi.utils.Converter.toNotification;
...
public class NotificationServiceImpl implements NotificationService {
    ...
    public Boolean send(Integer id , String body) {
        notificationRepository.save(
                toNotification(body , userRepository.findById(id).orElseThrow(UserNotFoundException::new))
        );
        return true;
    }

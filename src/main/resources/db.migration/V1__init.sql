...
CREATE TABLE black_list IF NOT EXISTS
(
...
CREATE TABLE users_chats IF NOT EXISTS
(
...
CREATE TABLE post IF NOT EXISTS
    ...
    CREATE TABLE post_images IF NOT EXISTS
    (
...
CREATE TABLE notification IF NOT EXISTS
(
    id       INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    message  VARCHAR(255),
    sent_at  TIMESTAMP WITHOUT TIME ZONE,
